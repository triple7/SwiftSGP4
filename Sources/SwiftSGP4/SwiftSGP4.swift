 ...
 epoch = targets.first!.EPOCH
        ...
        for target in targets {
            ...
            _ = sgp4init(wgs72, opsMode, &genSatNum
                     , jdEpoch, target.BSTAR, target.MEAN_MOTION_DOT/xpdotInv, target.MEAN_MOTION_DDOT/xpdotInv2, target.ECCENTRICITY*deg2rad, target.ARG_OF_PERICENTER*deg2rad, target.INCLINATION*deg2rad, target.MEAN_ANOMALY*deg2rad,
