...
{
    double am = 0, axnl = 0, aynl = 0, betal = 0, cosim = 0, cnod,
        cos2u = 0, coseo1 = 0, cosi = 0, cosip = 0, cosisq = 0, cossu = 0, cosu,
        delm = 0, delomg = 0, em = 0, emsq = 0, ecose = 0, el2 = 0, eo1,
        ep = 0, esine = 0, argpm = 0, argpp = 0, argpdf = 0, pl = 0, mrt = 0.0,
        mvt = 0, rdotl = 0, rl = 0, rvdot = 0, rvdotl = 0, sinim,
        sin2u = 0, sineo1 = 0, sini = 0, sinip = 0, sinsu = 0, sinu,
        snod = 0, su = 0, t2 = 0, t3 = 0, t4 = 0, tem5 = 0, temp,
        temp1 = 0, temp2 = 0, tempa = 0, tempe = 0, templ = 0, u = 0, ux,
        uy = 0, uz = 0, vx = 0, vy = 0, vz = 0, inclm = 0, mm,
        nm = 0, nodem = 0, xinc = 0, xincp = 0, xl = 0, xlm = 0, mp,
        xmdf = 0, xmx = 0, xmy = 0, nodedf = 0, xnode = 0, nodep = 0, tc = 0, dndt,
        twopi = 0, x2o3 = 0, vkmpersec = 0, delmtemp = 0;
    int ktr;
